...
export const projects: Project[] = [
  ...
  // },
  {
    ...
    fullDescription: '接触多种 UI 框架、组件库、前沿 JavaScript 基建工具的内部实践',
    highlights: [
      '学工系统前端 - Vue.js 框架实战',
      '心理中心前端 - React 框架实战',
      '机关党委官网 - 前端工具链深度定制',
  ...
  },
  {
    ...
    fullDescription: '探索 AI 技术在实际场景中的应用，让智能融入各行各业与生活。',
    highlights: [
      '导向标 - AI 智能导师信息平台',
      '畅行线 - AI Agent 赋能企业管理',
      '信小息 - AI 就业简历分析',
  ...
  },
  {
    ...
    fullDescription: '深入 Spring Boot 生态与 Node.js 技术栈，构建高可用后端服务。',
    highlights: [
      '心理中心后端 - Spring Boot 企业级架构',
      '学工部后端 - Koa 搭建 Node.js 高性能后端',
      '导师会客厅后端 - Spring Boot 微服务设计',
    ],
  ...
  },
  {
    ...
    fullDescription: '亲手设计服务全校师生的数据库结构，掌握企业级数据库技能。',
    highlights: [
      'MySQL / PostgreSQL - 关系型数据库',
      'MongoDB / Redis - NoSQL 与缓存方案',
      '性能优化 - 索引设计、查询优化',
    ],
  ...
  },
  {
    ...
    fullDescription: '接触生产环境服务器，掌握 DevOps 核心技能。',
    highlights: [
      '多台生产服务器管理 - 实际环境运维经验、服务器状态监控',
      '现代化 CI/CD - 企业级自动化测试、构建、部署全流程',
    ],
